#
# DEMENTED Audio Files
#

ALARM_PATH := vendor/DEMENTED/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/DEMENTED/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/DEMENTED/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/DEMENTED/prebuilt/common/media/audio/ui
